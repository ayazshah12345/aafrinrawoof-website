          ...
          <div className="flex items-center gap-3">
            ...
            {isAuthenticated && customer ? (
              ...
              <div className="hidden sm:flex items-center gap-2">
                ...
                <Link
                  to="/admin/login"
                  className="px-3 py-2 rounded-xl text-xs font-bold text-slate-500 dark:text-slate-400 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-950/40 transition-colors flex items-center gap-1.5 border border-slate-200 dark:border-slate-800"
